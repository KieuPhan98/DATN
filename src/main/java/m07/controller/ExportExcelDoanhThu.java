...
public class ExportExcelDoanhThu  {
    ...
    private void writeHeaderLine(String name, String datefrom, String dateto){
		...
		XSSFCellStyle style6 = dong6(workbook, sheet, 0, 4);
        ...
        createCell1(row, 3, "Tổng Số Lượng Bán", bold1);
        createCell1(row, 4, "Doanh Thu", bold1);
    }
    ...
    private void writeDataLines() {
        ...
        for (Object[] item : listDT) {
            ...
            sumSL += Integer.parseInt(String.valueOf(item[3]));
            sumDT += Double.parseDouble(String.valueOf(item[4]));
        ...
        createCell1(row, 4, sumDT , bold1);
        
        Row row2 = sheet.createRow(dem + 2);
        cell = row2.createCell(3, CellType.STRING);
		cell.setCellValue("TP.HCM, ngày " + currentDateTime);
		XSSFCellStyle dongNgay = dongNgay(workbook, sheet, 3, 4, dem + 2);  
