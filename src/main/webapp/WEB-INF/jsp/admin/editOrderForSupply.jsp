    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <div class="header">
                        <h4 class="title">SỬA PHIẾU ĐẶT</h4>
                    </div>
                   <div class="content">
                   ${message}
                        <form:form action="/admin/addOrderForSupplier" method="post" modelAttribute="order">
                            <div class="row">
                            
                            	<div class="col-md-2">
                                    <div class="form-group">
                                        <label>Mã phiếu đặt</label>                                           
                                        <form:input type = "text" path="id" class="form-control" required="true" readonly="true"></form:input>  
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <form:input type = "text" path="customer.id" class="form-control" required = "true" readonly="true"></form:input>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <form:input type = "text" path="createDate" class="form-control" required="true" readonly="true"></form:input>  
                                    </div>
                                </div> 
                            </div>
