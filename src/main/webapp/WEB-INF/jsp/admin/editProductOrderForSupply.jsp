                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <form:input path="id" type="text" class="form-control" name="id" readonly = "true"></form:input>
                                    </div>
                                </div>   
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <form:input path="orderForSupplier.id" type="text" class="form-control" readonly = "true"></form:input>
                                    </div>
                                </div>                                                        
                            </div>
