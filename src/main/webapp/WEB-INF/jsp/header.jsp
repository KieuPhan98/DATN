...
<div class="logo_products">
    <div class="container">
        ...
        <div class="w3ls_logo_products_left">
            <h1><a href="/"><img alt="" src="/resources/images/logo.PNG" style="width: 170px; height: 60px;"></a></h1>
        </div>
        ...
        <div class="cart box_1">			
					...
					<p><a href="/viewCart"><spring:message code="cart" text="default text"/></a></p>
		</div>
        ...
        <nav class="navbar navbar-default">
            ...
            <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                <ul class="nav navbar-nav">
                   ...
                   <%--  <li class="dropdown">
                    	<c:if test="${id == null}">
							<a href="/login" ><spring:message code="check" text="default text"/></a>
						</c:if>					
